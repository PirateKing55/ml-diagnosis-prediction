...
class ModelSurveyorHypertension:
    def __init__(self):
        # URLs for the datasets (replace with Hypertension-specific URLs if available)
        ...
        # Output model path for Hypertension
        self.model_path = "HypertensionPredict.pkl"
...
if __name__ == "__main__":
    surveyor = ModelSurveyorHypertension()
    surveyor.load_data()
    ...
    print("Hypertension model trained and tested successfully.")
