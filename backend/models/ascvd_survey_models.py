...
class ModelSurveyorASCVP:
    def __init__(self):
        # URLs for the datasets (replace with ASCVD-specific URLs if available)
        ...
        # Output model path for ASCVD
        self.model_path = "ASCVDPredict.pkl"
...
if __name__ == "__main__":
    ...
    print("ASCVP model trained and tested successfully.")
