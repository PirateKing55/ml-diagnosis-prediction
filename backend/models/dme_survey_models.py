...
class ModelSurveyorDME:
    def __init__(self):
        # URLs for the datasets (replace with DME-specific URLs if available)
        ...
        # Output model path for DME
        self.model_path = "DMEPredict.pkl"
...
if __name__ == "__main__":
    ...
    print("DME model trained and tested successfully.")
