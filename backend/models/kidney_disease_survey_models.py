...
class ModelSurveyorKidneyDisease:
    def __init__(self):
        # URLs for the datasets (replace with Kidney Disease-specific URLs if available)
        ...
        # Output model path for Kidney Disease
        self.model_path = "KidneyDiseasePredict.pkl"
...
if __name__ == "__main__":
    surveyor = ModelSurveyorKidneyDisease()
    surveyor.load_data()
    ...
    print("Kidney Disease model trained and tested successfully.")
