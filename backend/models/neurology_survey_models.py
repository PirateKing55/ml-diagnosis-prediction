...
class ModelSurveyorNeurology:
    def __init__(self):
        # URLs for the datasets (replace with Neurology-specific URLs if available)
        ...
        # Output model path for Neurology
        self.model_path = "NeurologyPredict.pkl"
...
if __name__ == "__main__":
    surveyor = ModelSurveyorNeurology()
    surveyor.load_data()
    ...
    print("Neurology model trained and tested successfully.")
