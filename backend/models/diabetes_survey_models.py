...
class ModelSurveyorDiabetes:
    def __init__(self):
        # URLs for the datasets (replace with Diabetes-specific URLs if available)
        ...
        # Output model path for Diabetes
        self.model_path = "DiabetesPredict.pkl"
...
if __name__ == "__main__":
    surveyor = ModelSurveyorDiabetes()
    surveyor.load_data()
    ...
    print("Diabetes model trained and tested successfully.")
