...
class ModelSurveyorLiverDisease:
    def __init__(self):
        # URLs for the datasets (replace with Liver Disease-specific URLs if available)
        ...
        # Output model path for Liver Disease
        self.model_path = "LiverDiseasePredict.pkl"
...
if __name__ == "__main__":
    surveyor = ModelSurveyorLiverDisease()
    surveyor.load_data()
    ...
    print("Liver Disease model trained and tested successfully.")
