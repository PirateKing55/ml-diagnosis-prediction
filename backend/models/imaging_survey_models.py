...
class ModelSurveyorImaging:
    def __init__(self):
        # URLs for the datasets (replace with Imaging-specific URLs if available)
        ...
        # Output model path for Imaging
        self.model_path = "ImagingPredict.pkl"
...
if __name__ == "__main__":
    ...
    print("Imaging model trained and tested successfully.")
